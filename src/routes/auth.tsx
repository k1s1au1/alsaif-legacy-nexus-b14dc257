...
function AuthPage() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center px-4 py-10 bg-background transition-colors duration-500">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(circle at 20% 80%, var(--gold-primary) 0%, transparent 35%), radial-gradient(circle at 80% 20%, var(--gold-primary) 0%, transparent 30%)",
        }}
      />

      <div
        className="relative w-full max-w-md bg-card rounded-[24px] overflow-hidden animate-fade-up border border-border shadow-gold"
      >
        <div className="px-8 pt-10 pb-6">
          <div className="flex flex-col items-center text-center mb-8">
            <div className="size-24 mb-4 grid place-items-center bg-gold-primary/5 rounded-full ring-1 ring-gold-primary/10 p-4">
              <img
                src={logoAsset.url}
                alt="شعار العلي"
            ...
            <p
              className="mt-2 text-[10px] font-bold tracking-[0.3em] text-gold-primary uppercase"
            >
          ...
          <>
            ...
            <form onSubmit={onSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-4 btn-gold rounded-xl text-sm font-bold disabled:opacity-50 flex items-center justify-center gap-2"
              >

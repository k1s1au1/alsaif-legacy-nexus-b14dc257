...
function AuthPage() {
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center p-4 md:p-10 bg-[#050608] overflow-hidden" dir="rtl">
      ...
      <div className="absolute inset-0 z-0">
         ...
         <motion.div
           ...
           className="absolute -bottom-[30%] -left-[10%] size-[900px] bg-primary/20 rounded-full blur-[150px]"
         />

         {/* Fine Texture Over Background */}
      ...
      <div className="relative z-10 w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
         ...
         <div className="hidden lg:flex flex-col space-y-10 animate-fade-up">
            ...
            <div className="flex items-center gap-10 pt-10 border-t border-white/5">
               <div className="space-y-1">
                  <p className="text-3xl font-black text-white tracking-tighter tabular-nums">1900+</p>
                  <p className="text-[10px] font-black uppercase tracking-widest text-white/30">تاريخ متجذر</p>
               </div>
               <div className="space-y-1">
                  <p className="text-3xl font-black text-gold-primary tracking-tighter tabular-nums">١٠٠٪</p>
                  <p className="text-[10px] font-black uppercase tracking-widest text-white/30">خصوصية عائلية</p>
               </div>
            </div>
         </div>
         ...
         <div className="w-full max-w-[500px] mx-auto">
            <motion.div
               layout
               className="relative overflow-hidden bg-white/[0.03] backdrop-blur-3xl border border-white/10 rounded-[48px] md:rounded-[60px] shadow-[0_40px_100px_-20px_rgba(0,0,0,0.6)]"
            >
               {/* Top Accent Gradient */}
                           ...
                           <form onSubmit={onLogin} className="space-y-5">
                              <div className="space-y-1.5">
                                 ...
                                 <div className="relative group">
                                    ...
                                    <input type="email" required value={email} onChange={e => setEmail(e.target.value)} className="auth-input-glass" placeholder="saud@alsaif.family" />
                                 </div>
                              </div>
                              ...
                              <div className="space-y-1.5">
                                 ...
                                 <div className="relative group">
                                    ...
                                    <input type={showPassword ? "text" : "password"} required value={password} onChange={e => setPassword(e.target.value)} className="auth-input-glass" placeholder="••••••••••••" />

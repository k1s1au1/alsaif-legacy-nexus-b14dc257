       ...
       <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center gap-2">
             <div className="flex items-center gap-1.5 flex-wrap">
               {currentRole !== "manager" && <RoleToggleBtn active={currentRole === "chairman"} onClick={() => onAssignRole(member.id, "chairman")} icon={<ShieldCheck className="size-3.5" />} label="رئيس" activeClass="bg-emerald-950 text-white shadow-xl ring-2 ring-gold-primary" />}

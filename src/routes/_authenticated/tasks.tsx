  ...
  return (
    <AppShell title="المسؤوليات" user={profile}>
      <div className="max-w-7xl mx-auto space-y-12 pb-24 px-4 md:px-0" dir="rtl">
        ...
        {/* Dynamic Header — Banner Style */}
        <section className="animate-fade-up">
          <div className="relative overflow-hidden rounded-[32px] md:rounded-[48px] bg-gradient-to-br from-[#064E3B] via-[#0A5A3E] to-black p-6 md:p-12 text-white shadow-2xl border border-white/5 group">

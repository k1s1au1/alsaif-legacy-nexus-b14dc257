  ...
  return (
    <AppShell title="المهام" user={profile}>
      <div className="max-w-5xl mx-auto text-center py-24">
        <ListChecks className="size-12 text-gold-primary mx-auto mb-6" strokeWidth={1.2} />
        <h2 className="text-2xl font-medium text-ivory mb-2">المهام والمسؤوليات</h2>
        <p className="text-sm text-muted-foreground max-w-md mx-auto">
          نظام إدارة المهام قيد التطوير. سيتم تفعيله قريباً لتتبع المهام والمسؤوليات بين أعضاء العائلة.
        </p>
      </div>
    </AppShell>
  );

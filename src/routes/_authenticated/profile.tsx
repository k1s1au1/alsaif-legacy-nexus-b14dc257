...
function ProfilePage() {
  ...
  return (
    <AppShell
      title="ملفي الشخصي"
      user={{ name: displayName, role: "عضو العائلة", initial, avatarPath: avatarUrl }}
    >
        ...
        <section className="flex flex-col md:flex-row items-center gap-10 animate-fade-up">
          <div className="relative group">
            ...
            <div className="relative size-40 md:size-56 rounded-[48px] bg-card border-4 border-white dark:border-border shadow-2xl overflow-hidden ring-1 ring-black/5 transition-transform duration-700 group-hover:scale-[1.02]">
              {avatarSrc ? (
                ...
                <div className="size-full flex items-center justify-center bg-primary/5 text-6xl font-black text-primary uppercase">
                  {initial}
                </div>
              )}
          ...
          <div className="flex-1 text-center md:text-right space-y-4">
            <div className="space-y-1">
              ...
              <p className="text-lg font-bold text-muted-foreground opacity-60">
                عضو مجلس عائلة السيف الموقر
              </p>
            </div>
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-4">
              ...
              <div className="flex items-center gap-2 bg-primary/5 px-4 py-1.5 rounded-full border border-primary/10 text-primary">
                ...
                <span className="text-xs font-black uppercase tracking-tighter">
                  منذ {new Date(createdAt).getFullYear()}م
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <form
              ...
              className="card-surface p-8 md:p-10 space-y-8 animate-fade-up"
            ...
            >
              <div className="flex items-center gap-4 border-b border-border/40 pb-6">
                <div className="size-12 rounded-2xl bg-rose-500/10 flex items-center justify-center text-rose-600 shadow-inner">
          ...
          <div className="space-y-8">
            <div
              className="card-surface p-8 space-y-6 relative overflow-hidden bg-primary text-white border-none shadow-2xl animate-fade-up"
            ...
            <div
              className="card-surface p-8 space-y-6 animate-fade-up"
...
function Field({
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="relative group">
        {icon && (
          <div className="absolute right-5 top-1/2 -translate-y-1/2 text-gold-primary/40 group-focus-within:text-primary transition-colors">
            {icon}
          </div>
        )}
        <input

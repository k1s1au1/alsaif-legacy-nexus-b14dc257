...
export const Route = createFileRoute("/_authenticated/archive")({
  ...
  head: () => ({
    meta: [
      { title: "الأرشيف — السيف" },
      { name: "description", content: "أرشيف صور ومستندات العائلة." },
    ],
  }),
  ...
  return (
    <AppShell title="الأرشيف" user={profile}>
      <div className="max-w-5xl mx-auto text-center py-24">
        <Archive className="size-12 text-gold-primary mx-auto mb-6" strokeWidth={1.2} />
        <h2 className="text-2xl font-medium text-ivory mb-2">أرشيف العائلة</h2>
        <p className="text-sm text-muted-foreground max-w-md mx-auto">
          قسم الأرشيف قيد التطوير. سيتم تفعيله قريباً لحفظ ومشاركة صور ومستندات العائلة.
        </p>
      </div>
    </AppShell>
  );

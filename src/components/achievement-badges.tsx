...
import { Award, History, Wallet, Users, CheckCircle2, Trophy } from "lucide-react";
...
const BADGES: Record<BadgeType, BadgeMeta> = {
  attender: {
    id: "attender",
    label: "وسام الحضور",
    description: "حضر العديد من الاجتماعات العائلية",
    icon: Users,
  ...
  storyteller: {
    id: "storyteller",
    label: "وسام الراوي",
    description: "ساهم في تدوين إرث وتاريخ العائلة",
    icon: History,
  ...
  supporter: {
    id: "supporter",
    label: "وسام الداعم",
    description: "مساهم فعال في صندوق العائلة",
    icon: Wallet,
  ...
  initiator: {
    id: "initiator",
    label: "وسام المبادرة",
    description: "قدم أفكاراً ومبادرات تطويرية",
    icon: Award,
  ...
  achiever: {
    id: "achiever",
    label: "وسام الإنجاز",
    description: "أنجز كافة المهام المسندة إليه",
    icon: CheckCircle2,
            ...
            <Tooltip key={b}>
              ...
              <TooltipContent className="bg-primary border-gold-primary/20 text-white p-3 rounded-2xl shadow-2xl">
                <div className="flex items-center gap-3">
                  <div
                    className={cn("size-8 rounded-xl flex items-center justify-center", meta.color)}
                  >
